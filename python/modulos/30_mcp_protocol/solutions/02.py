...
class ToolServer:
    def tools_list(self) -> list[dict[str, Any]]:
        return [
            ...
            {
                "name": "datetime_info",
                "description": "Devuelve fecha y hora",
                "inputSchema": {
                    "type": "object",
    ...
    def handle(self, request: dict[str, Any]) -> dict[str, Any]:
        try:
            ...
            return {
                "jsonrpc": "2.0",
                "id": request.get("id"),
                "error": {"code": -32010, "message": str(error)},
            }
...
def main() -> None:
    ...
    requests = [
        {"jsonrpc": "2.0", "id": 1, "method": "tools/list"},
        {
            ...
            "id": 2,
            "method": "tools/call",
            "params": {"name": "calculator", "arguments": {"expression": "10 / 2 + 7"}},
        },
        {
            "jsonrpc": "2.0",
            "id": 3,
            ...
            "params": {
                "name": "string_transform",
                "arguments": {"text": "mcp protocol", "operation": "title"},
            },
        },
        {
            "jsonrpc": "2.0",
            "id": 4,
            "method": "tools/call",
            "params": {"name": "datetime_info", "arguments": {"timezone_offset": -3}},
        },
    ]
