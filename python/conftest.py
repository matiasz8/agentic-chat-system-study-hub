...
def sample_state():
    ...
    return {"messages": [], "context": {}, "user_id": "test-user-123", "step": 0}
...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "unit: marca test como test unitario (rápido)")
    config.addinivalue_line("markers", "integration: marca test como integración (más lento)")
    config.addinivalue_line("markers", "llm: marca test que usa LLM real (requiere API key)")
